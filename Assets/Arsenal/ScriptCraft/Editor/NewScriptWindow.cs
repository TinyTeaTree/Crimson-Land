...
public class NewScriptWindow : EditorWindow {
    ...
    private const string kTemplatePath = "Arsenal/ScriptCraft/SmartScriptTemplates";
    ...
    class Styles {
        public GUIContent m_WarningContent = new GUIContent(string.Empty, null as Texture2D);
    ...
    [MenuItem("Assets/Create/ScriptCraft %&j")]
